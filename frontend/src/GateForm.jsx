...
const QUESTIONS = [
  {
    ...
    info: (
      <>
        ...
        <ul className="mt-1.5 mb-0 ml-4 list-disc p-0">
          <li>
            Uses fast flashes or similar techniques to unconsciously affect the
            user's behavior
          </li>
          <li>
            Targets people based on age, disability, or economic situation to
            influence their behavior
          </li>
          <li>
            Classifies individuals based on personality traits, leading to
            unfair treatment
          </li>
          <li>Predicts a person's risk of committing a crime</li>
          <li>
            Harvests faces from the internet or CCTV to build facial recognition
            databases
          </li>
          <li>
            Identifies people's emotions in a workplace or school environment
          </li>
          <li>
            Classifies individuals to deduce sensitive information like race or
            political views
          </li>
  ...
  },
  {
    ...
    info: (
      <>
        ...
        <ul className="mt-1.5 mb-0 ml-4 list-disc p-0">
          <li>
            Interactive AI: simulates human communication, whether through text,
            audio or video
          </li>
          <li>
            Generative AI: generate synthetic text or high-resolution images or
            video based on user prompts
          </li>
          <li>
            Deepfake AI: manipulate existing media to make things look or sound
            real when they are not
          </li>
          <li>
            Recognition AI: used for biometric identification or emotion
            detection
          </li>
        </ul>
    ...
    return (
      <div>
        ...
        <p className="mt-6">
          ...
          prohibited practices cannot legally be placed on the market or put
        ...
        <p className="mt-4">
          ...
          recognition in workplaces or schools, predictive policing based solely
          on profiling, untargeted scraping of facial images to build
          recognition databases, and biometric categorization to infer sensitive
    ...
    return (
      <div>
        ...
        <p className="mt-6">
          ...
          use case. GPAI models fall under a separate track of the Act, not the
        ...
        <p className="mt-4">
          ...
          copyright law, including via a publicly available summary of training
          content. Models classified as carrying <strong>systemic risk</strong>{" "}
          (Article 51) face additional obligations under Article 55, including
          model evaluation, adversarial testing, and incident reporting. These
        ...
        {!showQuestionnaire && (
          <>
            ...
            <p className="mt-6">
              ...
              scoring, or education) is high-risk; the exact same model used
            ...
            <p className="mt-4">
              ...
              on the paper <em>"Complying with the EU AI Act"</em> by Jacintha
              Walters, Diptish Dey, Debarati Bhaumik, and Sophie Horsman,
              published in 2023 and currently cited over 50 times. It should
      ...
      <div>
        ...
        <ul className="mt-4 space-y-2 list-disc pl-5">
          <li>
            ...
            AI — unless that's already obvious from context.
          </li>
          <li>
            If your system generates images, audio, video, or text, the output
            must be marked in a machine-readable way so it's detectable as
            AI-generated.
          </li>
          <li>
            If your system does emotion recognition or biometric categorization,
            you must inform the people it's used on.
          </li>
          <li>
            If your system creates deepfakes, or generates text published for
            informing the public, you must disclose that the content is
    ...
    return (
      <div>
        ...
        <p className="mt-6">
          ...
          trigger the transparency rules that apply to things like chatbots or
          synthetic content.
        </p>
        ...
        <p className="mt-4">
          ...
          people. For systems in this category, the EU AI Act doesn't currently
        ...
        <p className="italic text-muted-foreground mt-4">
          ...
          too. It's worth revisiting this assessment if your system's role
          evolves.
        </p>
        ...
        >
          <div className="max-w-[80ch]">
            ...
            <span
              ...
              className="relative ml-1.5 inline-block size-[1.2rem] cursor-help rounded-full bg-blue-600 text-center text-xs leading-[1.2rem] text-white"
            >
              i
              {hoveredKey === q.key && (
                <div className="absolute top-6 right-0 z-10 w-80 rounded bg-neutral-800 p-2.5 text-left text-sm leading-snug text-white">
                  {q.info}
                </div>
              )}
            </span>
          ...
          <div className="mt-2">
            <button
              ...
              className={cn(
                "cursor-pointer border border-border rounded-full px-8 py-2.5",
                answers[q.key] === true
            ...
            <button
              ...
              className={cn(
                "ml-4 cursor-pointer border border-border rounded-full px-8 py-2.5",
                answers[q.key] === false
